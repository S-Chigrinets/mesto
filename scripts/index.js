...
// функция закрытия попапа редактирования "Добавить место"
{
...
initialCards.forEach(function addCard(elem) {
  ...
  placeElement.querySelector('.element__button-delete').addEventListener('click',(e) =>
  {e.target.closest('.element').remove()})

  placeElement.querySelector('.element__button-like').addEventListener('click', (likeActive) =>
  {placeElement.querySelector('.element__button-like').classList.toggle('element__button-like_active')});
